# nvim-treesitter-queries-matlab

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-matlab/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-matlab/actions/workflows/validate.yml)

Neovim tree-sitter queries for **matlab**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-matlab",
...
- [ ] Changes are scoped to `matlab` — do not include files for other languages
